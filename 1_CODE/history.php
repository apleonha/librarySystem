...
<body>
	...
	<center>
		...
		<p>(812)555-1234</p>
		<button onclick ="location.href = 'localhost:8888/libraryHome.html';">Home</button>
    	<button onclick = "location.href = 'localhost:8888/searchCatalogue.html';">Search Catalogue</button>
	</center>
...
<?php
	...
	$sql1 = "SELECT inventorytitles.title, checkOutHistory.checkOutDate, checkOutHistory.dateDue, checkOutHistory.returnDate FROM checkOutHistory JOIN inventorytitles ON checkOutHistory.inventoryID = inventorytitles.inventoryID WHERE cardNo = 1";
